...
public class StockController {
	 ...
	 */
	public static double getCantidadStock (Actor actor, MateriaPrima mp) throws ClassNotFoundException, SQLException, equipo5.model.NotInDatabaseException{
		try {
	 ...
	 */
		public static int getStockLote(Actor actor, Lote lote) throws equipo5.model.NotInDatabaseException {
	...
	public String getStockActor(
		...
		for(int i = 0; i < lista_nombre_mp.length; i++) 
		{
			try {
				...
				stock.addProperty(lista_nombre_mp[i][0], metodosCompany.extraerStockMP(actor,mp));
			} catch (Exception e) {
