...
//			insertarLote(lotemal);
			...
			insertarOrdenes();
			int idOr=850;
			String idActor = extraerOrdenTrazabilidad(850).getActorOrigen().getId();
			Lote loteTere = new Lote(idOr, dateiniG3_1, datefinG3_1, null, false, true, false, true, false, "pilsner",
					dateMoli1, dateCoci1, dateFerme1_1, dateFerme1_2, dateEmbo1);
