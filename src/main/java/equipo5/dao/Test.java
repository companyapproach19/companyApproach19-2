...
public class Test extends metodosCompany {
	...
	public static void main(String[] args) throws Throwable {
		try {
			...
			StockMP stockG2_1 = new StockMP(cebadaTostada, null, null, 50, 5, "0");
			StockMP stockG2_2 = new StockMP(levaduraAle, null, null, 50, 5, "0");
			StockMP stockG2_3 = new StockMP(maltaNegra, null, null, 51, 5, "1");
			StockMP stockG2_4 = new StockMP(maltaPilsner, null, null, 51, 5, "1");
			StockMP stockG2_5 = new StockMP(levaduraLager, null, null, 52, 5, "2");
			StockMP stockG2_6 = new StockMP(maltaChocolate, null, null, 52, 5, "2");
			StockMP stockG2_7 = new StockMP(maltaPilsner, null, null, 53, 5, "3");
			StockMP stockG2_8 = new StockMP(levaduraAle, null, null, 53, 5, "3");
...
//			insertarLote(lotemal);
			...
			StockMP stockMp1 = new StockMP(cebadaTostada, null, datefinstock1, 1, 1, "0");
			StockMP stockMp2 = new StockMP(lupuloPerle, null, datefinstock2, 2, 2, "1");
			StockMP stockMp3 = new StockMP(levaduraAle, null, datefinstock2, 1, 1, "3");
			StockMP stockMp4 = new StockMP(cebadaTostada, null, datefinstock3, 2, 2, "4");
			StockMP stockMp5 = new StockMP(maltaChocolate, null, datefinstock2, 1, 1, "1");
			StockMP stockMp6 = new StockMP(levaduraAle, null, datefinstock4, 2, 2, "3");
			StockMP stockMp7 = new StockMP(cebadaTostada, null, datefinstock3, 1, 1, "2");
			StockMP stockMp8 = new StockMP(levaduraLager, null, datefinstock4, 1, 1, "0");
			...
			Date dateinilote1 = Date.valueOf("2017-11-6");
			Date datefinlote1 = Date.valueOf("2017-11-16");
			Date dateinilote2 = Date.valueOf("2017-11-21");
			Date datefinlote2 = Date.valueOf("2017-11-27");
			Date dateinilote3 = Date.valueOf("2016-11-6");
			Date datefinlote3 = Date.valueOf("2016-11-16");
			Date dateinilote4 = Date.valueOf("2016-11-21");
			Date datefinlote4 = Date.valueOf("2016-11-27");
			...
			StockLote stockLote1 = new StockLote(lote1, null, datefinlote1, 11, 11, "0");
			StockLote stockLote2 = new StockLote(lote2, null, datefinlote2, 2, 2, "1");
			StockLote stockLote3 = new StockLote(loteG3_1, null, datefinlote1, 2, 2, "2");
			StockLote stockLote4 = new StockLote(lote2, null, datefinlote2, 1, 1, "4");
			StockLote stockLote5 = new StockLote(loteG3_1, null, datefinlote3, 2, 2, "0");
			StockLote stockLote6 = new StockLote(loteSt1, null, datefinlote4, 11, 11, "3");
			StockLote stockLote7 = new StockLote(loteSt1, null, datefinlote4, 2, 2, "1");
			StockLote stockLote8 = new StockLote(loteSt1, null, datefinlote3, 11, 11, "1");
			...
			insertarOrdenes();
//			int idOr=850;
//			String idActor = extraerOrdenTrazabilidad(1302).getActorOrigen().getId();
//			Lote loteTere = new Lote(idOr, Date.valueOf("2017-11-6"), Date.valueOf("2017-11-6"), null, false, true, false, true, false, "pilsner",
//					Date.valueOf("2017-11-6"), Date.valueOf("2017-11-6"), Date.valueOf("2017-11-6"), Date.valueOf("2017-11-6"), Date.valueOf("2017-11-6"));
//			loteTere.setQr(GeneradorQR2.generadorQR(loteTere.getIdBd()));
////			insertarLote(loteTere);
//			StockLote stockLote = new StockLote(loteTere, dateinilote1, null, idOr, idOr, idActor);
//			insertarStockLote(stockLote);
//			
//			
