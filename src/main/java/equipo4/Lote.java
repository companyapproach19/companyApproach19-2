...
public class Lote {
	...
	public Lote(int idBd, int code, Date fecha_inicio, Date fecha_final,boolean molido, boolean cocido, boolean fermentado, boolean fermentado2, boolean embotellado) {
		this.idBd= idBd;
		this.code=code;
