...
function rellenaPopup(stock,actor) {
    ...
    case "Agricultor":
	$("popup" + actor).append("<br><br>Datos del Agricultor<br>Nombre: " + stock.nomUsuario + "<br>Email: " + stock.email + "<br><br>Stock del Agricultor: MUCHO STOCK, TIENE MUCHOS ELEMENTOS DE ESTOC (organizar los tipos de materias y lotes en columnas (malta, levadura, lotes, etc, y ya los asociaré a la info del JSON)");
	break;

    case "Cooperativa":
	$("popup" + actor).append("<br><br>Datos de la Cooperativa<br>Nombre: " + stock.nomUsuario + "<br>Email: " + stock.email + "<br><br>Stock de la Cooperativa: MUCHO STOCK, TIENE MUCHOS ELEMENTOS DE ESTOC (organizar los tipos de materias y lotes en columnas (malta, levadura, lotes, etc, y ya los asociaré a la info del JSON)");
	break;
	
    case "Fabrica":
	$("popup" + actor).append("<br><br>Datos de la Fábrica<br>Nombre: " + stock.nomUsuario + "<br>Email: " + stock.email + "<br><br>Stock de la Fábrica: MUCHO STOCK, TIENE MUCHOS ELEMENTOS DE ESTOC (organizar los tipos de materias y lotes en columnas (malta, levadura, lotes, etc, y ya los asociaré a la info del JSON)");
	break;
