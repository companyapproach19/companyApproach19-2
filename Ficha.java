...
public class Ficha extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pedido = (Pedido) extras.get("pedido");
        ...
        nombre.setText(pedido.getTrasportista().getNombre());
        id.setText(pedido.getId());
        fechR.setText(pedido.getTrasportista().getFecha_recogida());
        fechE.setText(pedido.getTrasportista().getFecha_entrega());
    ...
    public void firmarPedido () {
        ...
        if (Integer.parseInt(id.getText().toString()) != pedido.getId())
            Toast.makeText(this, "No puedes cambiar el ID del pedido", Toast.LENGTH_SHORT).show();

        Intent intent = new Intent(this, MainActivity.class);

        pedido.getTrasportista().setNombre(nombre.getText().toString());
        pedido.getTrasportista().setFecha_recogida(fechR.getText().toString());
        pedido.getTrasportista().setFecha_entrega(fechE.getText().toString());
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        pedido.getTrasportista().setEmpresa(empresas[position]);
    }
